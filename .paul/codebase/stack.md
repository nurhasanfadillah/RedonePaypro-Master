...
| recharts | 2.12.7 | Chart/visualisasi data |
...
- URL: `https://sartektzisafnmbiuhwd.supabase.co` (hardcoded fallback)
...
| `GEMINI_API_KEY` | Google Gemini (belum digunakan aktif) |

`.env.example` ada tapi **kosong (0 bytes)**.
